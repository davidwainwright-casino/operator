...
<x-slot name="header">
    ...
    <div class="max-w-fluid dark:bg-gray-900 mx-auto py-4 px-2 sm:px-6 lg:px-8">                
            ...
            <div class="group relative bg-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 dark:bg-gray-700 rounded-2xl shadow-md cursor-pointer">
                <div class="mb-1">
                    <div class="image block w-full h-full items-center object-cover justify-center">
                        <div class="transition duration-300 ease absolute opacity-0 group-hover:opacity-100 z-10 items-center p-2"><button class="inline-flex items-center px-4 py-2 bg-purple-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-purple-900 active:bg-purple-800 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition ml-1">Play</button></div>    
                        <img class="object-cover rounded-t-lg w-full opacity-100 group-hover:opacity-25" src="{{ $game->thumb($game->gid) }}" loading="lazy">
                    </div>
                    <div class="py-2 px-3"> 
