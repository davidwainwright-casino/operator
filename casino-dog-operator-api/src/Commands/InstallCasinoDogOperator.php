...
class InstallCasinoDogOperator extends Command
{
    ...
    public function handle()
    {
        ...
        /* info box */
        $this->info('Completed. If you use the defaulted games gallery frontend run the following:');
        $this->info('>> Run artisan "casino-dog:sync-games-table" to synchronize the database table for operator frontend.');
        $this->line('');
