...
use Wainwright\CasinoDogOperatorApi\Controllers\AblyController;
...
class APIController
{
   ...
   protected $operator_key;
    ...
    {
        $this->ably_controller = new AblyController;
...
public function play($slug, Request $request)
{
    ...
    if(isset($create_session_request['message'])) {
    	if(isset($create_session_request['message']['session_url'])) {
            ...
            $this->ably_controller->send_message('mood', 'createSession', json_encode($data));
